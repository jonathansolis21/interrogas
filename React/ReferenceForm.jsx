...
import { addReference } from '../../services/referenceService';
        ...
        <React.Fragment>
            <PageTitle
                breadCrumbItems={[
                    ...
                    { label: 'Add Reference', path: '/references/new', active: true },
                ]}
                title={location.pathname === '/references/update/:id' ? 'Update Reference' : 'Add Reference'}
            />
